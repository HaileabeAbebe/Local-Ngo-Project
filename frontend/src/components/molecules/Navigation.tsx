    ...
    <div className="relative">
      <nav
        ...
        <div className="flex justify-end items-center">
          <button
            className={`block lg:hidden focus:outline-none mr-5 ${
          ...
          <div
            className={`space-x-8 transition duration-300 ease-in-out overflow-hidden lg:flex mr-8 ${
              isNavOpen
          ...
          {isLoggedIn ? (
            <div className={`lg:flex ${isNavOpen ? "hidden" : "block"}`}>
              <Profile />
            </div>
          ) : (
            <Link
